...
var satellitemap = L.tileLayer("https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={pk.eyJ1Ijoic2FyYWhncmFudDExIiwiYSI6ImNrZ2k1dXJtNTFrbXAycWxqN24yMXNma3kifQ.RfqdT0P8DrPVL9ZcW_AItw}", {
  attribution: "Map data &copy; <a href='https://www.openstreetmap.org/'>OpenStreetMap</a> contributors, <a href='https://creativecommons.org/licenses/by-sa/2.0/'>CC-BY-SA</a>, Imagery © <a href='https://www.mapbox.com/'>Mapbox</a>",
  maxZoom: 18,
...
var outdoors = L.tileLayer("https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={pk.eyJ1Ijoic2FyYWhncmFudDExIiwiYSI6ImNrZ2k1dXJtNTFrbXAycWxqN24yMXNma3kifQ.RfqdT0P8DrPVL9ZcW_AItw}", {
  attribution: "Map data &copy; <a href='https://www.openstreetmap.org/'>OpenStreetMap</a> contributors, <a href='https://creativecommons.org/licenses/by-sa/2.0/'>CC-BY-SA</a>, Imagery © <a href='https://www.mapbox.com/'>Mapbox</a>",
  maxZoom: 18,
  id: "mapbox.outdoors",
  accessToken: apiKey
...
// create the map object with options. Adding the tile layers we just created to an array of layers.
var map = L.map("mapid", {
  center: [
    40.7, -94.5
  ],
